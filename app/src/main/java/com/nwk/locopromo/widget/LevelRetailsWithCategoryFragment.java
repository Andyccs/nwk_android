...
public class LevelRetailsWithCategoryFragment extends Fragment {
    ...
    public LevelRetailsWithCategoryFragment() {

    }

    public static LevelRetailsWithCategoryFragment newInstance(String category,int level) {
        LevelRetailsWithCategoryFragment fragment = new LevelRetailsWithCategoryFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(level==0){
            throw new IllegalArgumentException("must provide a level information for this fragment" +
                    "\nExample: LevelRetailsWithCategoryFragment.newInstance(FOOD,1);");
        }
    }
    ...
    private void initializeData() {
        ((PromoApplication)(getActivity().getApplication())).getService().listRetails(
                category, ""+level, new Callback<List<Retail>>() {
            @Override
